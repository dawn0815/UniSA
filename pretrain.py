...
DATASET_NAMES = (
   'iemocap_pretrain','meld_pretrain','mosi_pretrain','mosei_pretrain','emoji_pretrain','emory_pretrain','daily_pretrain','sst_pretrain','imdb_pretrain','amazon_pretrain','emowoz_pretrain','sarc_pretrain','concat_pretrain',
    'iemocap_val','meld_val','mosi_val','mosei_val','emoji_val','daily_val','emory_val','sst_val','imdb_val','amazon_val','emowoz_val','sarc_val','concat_val',
...
def main(rank, args):
    ...
    if 'concat_pretrain' in args.dataset:
        pretrain_dataset_list.append(PretrainDataset(
            args.dataset['concat_pretrain'],use_text=True,use_image=True,use_audio=True))
    if 'concat_val' in args.dataset:    
        val_dataset_list.append(PretrainDataset(
            args.dataset['concat_val'],use_text=True,use_image=True,use_audio=True))
