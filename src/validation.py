...
def validate(
    ...
    # f_1 = open(f'root/data/ruiren/loss_epoch/loss_epoch_{epoch}.txt', 'w')  
    # f_1.write('total loss : '+str(total_loss))
    # f_1.write('\r\n')
    # f_1.write('meld : '+str(meld_loss))
    # f_1.write('\r\n')
    # f_1.write('iemocap : '+str(iemocap_loss))
    # f_1.write('\r\n')
    # f_1.write('emory : '+str(emory_loss))
    # f_1.write('\r\n')
    # f_1.write('daily : '+str(daily_loss))
    # f_1.write('\r\n')
    # f_1.write('mosi : '+str(mosi_loss))
    # f_1.write('\r\n')
    # f_1.write('mosei : '+str(mosei_loss))
    # f_1.write('\r\n')
    # f_1.write('emoji : '+str(emoji_loss))
    # f_1.write('\r\n')
    # f_1.write('sst : '+str(sst_loss))
    # f_1.write('\r\n')
    # f_1.write('imdb : '+str(imdb_loss))
    # f_1.write('\r\n')
    # f_1.write('amazon : '+str(amazon_loss))
    # f_1.write('\r\n')
    # f_1.write('emowoz : '+str(emowoz_loss))
    # f_1.write('\r\n')
    # f_1.write('meld confusion_matrix')
    # f_1.write('\r\n')
    # meld_report=confusion_matrix(meld_label,meld_pre,labels=['joy','neutral','fear','surprise','disgust','sad','angry'])
    # for i in meld_report:
    #     f_1.write(str(i))
    #     f_1.write('\r\n')
    # f_1.write('\r\n')
    # f_1.write('iemocap confusion_matrix')
    # f_1.write('\r\n')
    # iemocap_report=confusion_matrix(iemocap_label,iemocap_pre,labels=['neutral','angry','frustrate','sad','happy','excited'])
    # for i in iemocap_report:
    #     f_1.write(str(i))
    #     f_1.write('\r\n')
    # f_1.write('\r\n')
    # f_1.write('emory confusion_matrix')
    # f_1.write('\r\n')
    # emory_report=confusion_matrix(emory_label,emory_pre,labels=['joy','neutral','fear','mad','peaceful','sad','powerful'])
    # for i in emory_report:
    #     f_1.write(str(i))
    #     f_1.write('\r\n')
    # f_1.write('\r\n')
    # f_1.write('daily confusion_matrix')
    # f_1.write('\r\n')
    # daily_report=confusion_matrix(daily_label,daily_pre,labels=['angry','sad','happy','disgust','fear','surprise'])
    # for i in daily_report:
    #     f_1.write(str(i))
    #     f_1.write('\r\n')
    # f_1.write('\r\n')
    # f_1.write('emowoz confusion_matrix')
    # f_1.write('\r\n')
    # emowoz_report=confusion_matrix(emowoz_label,emowoz_pre,labels=['neutral','dissatisfied','sad','happy','apology','abusive','satisfied'])
    # for i in emowoz_report:
    #     f_1.write(str(i))
    #     f_1.write('\r\n')
    # f_1.write('\r\n')
    # f_1.write('emoji confusion_matrix')
    # f_1.write('\r\n')
    # emoji_report=confusion_matrix(emoji_label,emoji_pre,labels=['neutral','angry','sad','happy','love','fear','surprise'])
    # for i in emoji_report:
    #     f_1.write(str(i))
    #     f_1.write('\r\n')
    # f_1.write('\r\n')
    # f_1.close()
